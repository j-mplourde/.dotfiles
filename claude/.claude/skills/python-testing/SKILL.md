---
name: python-testing
description: Python Testing Library patterns for testing Python code. Use when testing Python applications.
---
...
**Python components are just functions that return JSX.** Test them like functions: inputs (props) → output (rendered DOM).
